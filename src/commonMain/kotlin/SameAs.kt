...
import com.xemantic.kotlin.test.diff.UnifiedDiff
 ...
 *
 * Note: Implemented in common source set using a multiplatform diff generator.
 *
...
public infix fun String?.sameAs(expected: String?) {
    ...
    val unifiedDiff = UnifiedDiff.generate(
        originalName = "expected",
        revisedName = "actual",
        original = expectedLines,
        revised = actualLines,
        contextSize = 0
    )
